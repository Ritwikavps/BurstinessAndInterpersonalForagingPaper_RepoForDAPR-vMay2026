...
%Inputs:
    ...
    %- WithOrWoCtrlTxt: string specifying whether the results being plotted is for with or without control tests ('w/ ctrl','w/o ctrl').
    %- MainOrSI: string specifying whether the plot is for main text or SI ('MainTxt','SI').

u_RespToSpkr = {'ANRespToCHNSP','CHNSPRespToAN'}; %get list of response_to_spekar strings (ANRespToCHNSP, CHNSPRespToAN)
YlabelTxt = {'Ad response to ChSp','ChSp response to Ad'}; %text for Y axis label corresponding to thd speaker and response type
